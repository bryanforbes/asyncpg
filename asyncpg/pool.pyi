...
class _SetupCallback(compat.Protocol[_Record]):
    async def __call__(self, __proxy: PoolConnectionProxy[_Record]) -> None: ...

class _InitCallback(compat.Protocol[_Record]):
...
class PoolConnectionProxy(connection._ConnectionProxy[_Record],
    ...
    async def add_listener(self, channel: str, callback: connection.Listener) -> None: ...
    async def remove_listener(self, channel: str, callback: connection.Listener) -> None: ...
    ...
    def add_termination_listener(self, callback: connection.TerminationListener) -> None: ...
    def remove_termination_listener(self, callback: connection.TerminationListener) -> None: ...
    ...
    def transaction(self, *,
                    ...
                    readonly: bool = ...,
                    deferrable: bool = ...) -> transaction.Transaction: ...
    ...
    async def fetchval(self, query: str, *args: typing.Any, column: int = ...,
    ...
    async def copy_from_table(self, table_name: str, *,
                              ...
                              encoding: typing.Optional[str] = ...) -> str: ...
...
class Pool(typing.Generic[_Record]):
    def set_connect_args(self, dsn: typing.Optional[str] = ..., *,
    ...
    async def fetchval(self, query: str, *args: typing.Any, column: int = ...,
                       timeout: typing.Optional[float] = ...) -> typing.Any: ...
    async def fetchrow(self, query: str, *args: typing.Any,
                       timeout: typing.Optional[float] = ...) \
            -> typing.Optional[_cprotocol.Record]: ...
    def acquire(self, *, timeout: typing.Optional[float] = ...) \
            -> PoolAcquireContext[_Record]: ...
    async def release(self, connection: PoolConnectionProxy[_Record], *,
                      timeout: typing.Optional[float] = ...) -> None: ...
    async def close(self) -> None: ...
    def terminate(self) -> None: ...
    ...
    def __await__(self: _Pool) -> typing.Generator[typing.Any, None,
                                                   typing.Optional[_Pool]]: ...
